...
pub struct StoreOnChainWalletsCreateOnChainTransaction200Response {
    /// The transaction id
...
impl StoreOnChainWalletsCreateOnChainTransaction200Response {
    pub fn new() -> StoreOnChainWalletsCreateOnChainTransaction200Response {
